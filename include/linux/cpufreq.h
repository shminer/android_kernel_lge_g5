...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ALUCARD_OLD)
extern struct cpufreq_governor cpufreq_gov_alucard_old;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_alucard_old)
#endif
